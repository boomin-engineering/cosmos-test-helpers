...
{
    [SuppressMessage("", "SA1131", Justification = "I want this code to work regardless of the ordering of the equals")]
    ...
    public sealed class CosmosEnumTests : IAsyncLifetime, IDisposable
    {
        ...
        public async Task GivenAQueryUsingAValueForNullableEnumWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et1", q => q.Where(tm => tm.NullableEnum.Value != null && tm.NullableEnum == TestEnum.Value1));
        ...
        public async Task GivenAQueryUsingAValueForNullableOnSubModelEnumWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et2", q => q.Where(tm => tm.OnlyChild != null && tm.OnlyChild.NullableEnum.Value != null && tm.OnlyChild.NullableEnum == TestEnum.Value1));
        ...
        public async Task GivenAQueryUsingAValueForNullableEnumWhenExecutingThenTheResultsShouldMatchReversedEquality()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et3", q => q.Where(tm => null != tm.NullableEnum.Value && TestEnum.Value1 == tm.NullableEnum));
        ...
        public async Task GivenAQueryUsingNullableEnumWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et4", q => q.Where(tm => tm.NullableEnum.Value == null));
        ...
        public async Task GivenAQueryUsingNullableEnumOnSubmodelWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et5", q => q.Where(tm => tm.OnlyChild.NullableEnum.Value == null));
        ...
        public async Task GivenAQueryUsingNotNullEnumOnSubmodelWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et6", q => q.Where(tm => tm.OnlyChild.NullableEnum.Value != null));
        ...
        public async Task GivenAQueryUsingNullableEnumWhenExecutingThenTheResultsShouldMatchReversedEquality()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et7", q => q.Where(tm => null == tm.NullableEnum.Value));
        ...
        public async Task GivenAQueryUsingAValueForNullableNonStringEnumWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et8", q => q.Where(tm => tm.NullableEnumNotString.Value != null && tm.NullableEnumNotString == TestEnum.Value1));
        ...
        public async Task GivenAQueryUsingNullableNonStringEnumWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition-et9", q => q.Where(tm => tm.NullableEnumNotString.Value == null));
