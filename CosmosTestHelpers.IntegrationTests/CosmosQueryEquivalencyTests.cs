...
namespace CosmosTestHelpers.IntegrationTests
{
    ...
    public sealed class CosmosQueryEquivalencyTests : IAsyncLifetime, IDisposable
    {
        ...
        public async Task GivenAQueryUsingEqualsWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => tm.Name == "Bob Bobertson"));
        ...
        public async Task GivenAQueryUsingContainsOnAnEnumWithAToStringWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => new[] { TestEnum.Value2.ToString() }.Contains(tm.EnumValue.ToString())));
        ...
        public async Task GivenAQueryUsingProjectionWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Select(tm => new TestModel { Name = "Projected" }));
        ...
        public async Task GivenAQueryUsingNotEqualsWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => tm.Name != "Bobbeta Bobertson"));
        ...
        [Fact]
        [SuppressMessage("", "CA1304", Justification = "Culture Not Supported")]
        public async Task GivenAQueryUsingToUpperWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => tm.Name.ToUpper() == "BOB BOBERTSON"));
        ...
        public async Task GivenAQueryUsingToLowerWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => tm.Name.ToLower() == "bob bobertson"));
        ...
        public async Task GivenAQueryUsingAnyInASubQueryWhenExecutingThenTheResultsShouldMatch()
        {
            ...
            var (realResults, testResults) = await _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => tm.Children.Any(c => c.Value == "bob bobertson")));
        ...
        public async Task GivenAQueryUsingToUpperInvariantWhenExecutingThenBothShouldError()
        {
            ...
            Func<Task> action = () => _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => tm.Name.ToUpperInvariant() == "BOB BOBERTSON"));
        ...
        [Fact]
        [SuppressMessage("", "CA1308", Justification = "Specifically testing")]
        public async Task GivenAQueryUsingToLowerInvariantWhenExecutingThenBothShouldError()
        {
            ...
            Func<Task> action = () => _testCosmos.WhenExecutingAQuery<TestModel>("partition", q => q.Where(tm => tm.Name.ToLowerInvariant() == "bob bobertson"));
